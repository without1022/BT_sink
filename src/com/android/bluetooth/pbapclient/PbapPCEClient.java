...
public class PbapPCEClient  implements PbapHandler.PbapListener {
	...
	public    PbapPCEClient(Context context,MainHandler handler) {
        mContext = context;
		mainHandler = handler;
		// Message.obtain(mainHandler,StaticMessage.PROFILE_CONNECT_AVRCP_CONTROLLER,"PBapPCEclient get the mainHanindler").sendToTarget();
    ...
    private void downloadPhoneBook() {
        ...
        PhonebookPullRequest pb = new PhonebookPullRequest(mContext, mAccount,mainHandler);
        addPullRequest(pb);
    }
